...
@section('content')
    ...
    <form action="/renicantik/list-bso" method="POST"  enctype="multipart/form-data" >
        @csrf
        <div class="form-group">
            <label for="title">Title</label>
            <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}"  placeholder="BSO name">
            @error('title')
        ...
        <br>
        <button type="submit" class="btn btn-primary">Add BSO</button>
