...
@section('content')
    ...
    <form action="/renicantik/list-himpunan" method="POST"  enctype="multipart/form-data" >
        @csrf
        <div class="form-group">
            <label for="title">Title</label>
            <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}"  placeholder="Himpunan name">
            @error('title')
        ...
        <br>
        <button type="submit" class="btn btn-primary">Add Himpunan</button>
